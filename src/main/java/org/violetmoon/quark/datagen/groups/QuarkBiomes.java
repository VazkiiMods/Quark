...
public class QuarkBiomes {
	...
	private static Biome glimmeringWeald(HolderGetter<PlacedFeature> placedFeatures, HolderGetter<ConfiguredWorldCarver<?>> worldCarvers) {
        ...
        mobSpawnSettingsBuilder.addSpawn(MobCategory.UNDERGROUND_WATER_CREATURE, new MobSpawnSettings.SpawnerData(EntityType.GLOW_SQUID, 20, 4, 6));
        ...
        biomeGenerationSettingsBuilder.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, Quark.asResourceKey(Registries.PLACED_FEATURE, "ore_lapis_extra"));
