...
public class ToretoiseModule extends ZetaModule {
	...
	public final void register(ZRegister event) {
		...
		Quark.ZETA.entitySpawn.registerSpawn(toretoiseType, MobCategory.CREATURE, SpawnPlacementTypes.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, Toretoise::spawnPredicate, spawnConfig);
