...
public class FoxhoundArmorLayer extends RenderLayer<Foxhound, FoxhoundModel> {
    ...
    public FoxhoundArmorLayer(RenderLayerParent<Foxhound, FoxhoundModel> renderer, EntityModelSet models) {
        super(renderer);
    ...
    public void render(
        ...
        if (livingEntity.hasArmor()) {
            ...
            if (itemstack.getItem() instanceof AnimalArmorItem armor && armor.getBodyType() == AnimalArmorItem.BodyType.CANINE) {
                ...
                VertexConsumer vertexconsumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(Quark.asResource("textures/model/entity/foxhound/foxhound_armor.png")));
