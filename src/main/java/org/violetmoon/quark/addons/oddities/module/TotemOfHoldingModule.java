...
public class TotemOfHoldingModule extends ZetaModule {
	...
	@Config(description = "Min item drops per hit (Set to -1 to drop everything the first hit)")
	public static int minDropsRecoveredPerHit = 3;
	@Config(description = "Max item drops per hit (Set to -1 to drop everything the first hit)")
